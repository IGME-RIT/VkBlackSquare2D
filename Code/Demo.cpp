...
void Demo::prepare_pipeline()
{
	...
	// we say how large each piece of the vertex is. In this case, there is only
	// one piece of data in each vertex, and that is position, but this will
	// change in future tutorials
	VkVertexInputAttributeDescription vertexInputAttributs[1];
	memset(vertexInputAttributs, 0, sizeof(VkVertexInputAttributeDescription));
	...
	// We tell it how many attributes there are: (one) (position),
